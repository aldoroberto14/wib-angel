...
ks = LINETCR.LINE()
#ks.login(qr=True)
ks.login(token="EojeD0tztvLuHWTlMINb.F3dwbSK4u10C9ILUzTcpQW.g0JMsiy2uSJeIYj4Ot4k/Cca08q7Yot0BASb28sugJI=")
ks.loginResult()

satpam = LINETCR.LINE() 
satpam.login(token="Eo8mmqMuNQI9nzPkrcpf.TZjEI917pMDTTp1BY9K5+W.cYdG2Tucf/t021bNcwL27jjwDMfIXP584viOUGvSKd0=")
...
["u7c6d976a4f3f0ba998f7664dab9fc02b"]
Amid = ki.getProfile().mid
["u4ec97a9c8fdb3c8be07cf66af60536d8"]
Bmid = kk.getProfile().mid
["u5d473c93afc666348c10df7512d46ca6"]
Cmid = kc.getProfile().mid
["u724a7a829e6031f605c9491739496bc4"]
Dmid = ks.getProfile().mid
["u7f70d606c938535d1cf6296e66d08fab"]
Smid = satpam.getProfile().mid
["ub7325e8bdd7b3e676db4fd5bcbd939ff"]
...
induk=["u4a361586c55ac4ef218a0a9b78b2f1b3","u4fd239a77c16d1ea7853cd801f6c379d","u3be861eaf85ef27656cf9159916229ca","u7c6d976a4f3f0ba998f7664dab9fc02b"]
Creator=["u4a361586c55ac4ef218a0a9b78b2f1b3","u4fd239a77c16d1ea7853cd801f6c379d","u3be861eaf85ef27656cf9159916229ca","u7c6d976a4f3f0ba998f7664dab9fc02b"]
admin=["u4a361586c55ac4ef218a0a9b78b2f1b3","u4fd239a77c16d1ea7853cd801f6c379d","u3be861eaf85ef27656cf9159916229ca","u7c6d976a4f3f0ba998f7664dab9fc02b"]
owner=["u4a361586c55ac4ef218a0a9b78b2f1b3","u4fd239a77c16d1ea7853cd801f6c379d","u3be861eaf85ef27656cf9159916229ca","u7c6d976a4f3f0ba998f7664dab9fc02b"]
wait = {
    'contact':False,
    'autoJoin':True,
...
Idline: http://line.me/ti/p/~oscwib""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€  ℬℽ : W⃟   I⃟   B⃟    »»» http://line.me/ti/p/~oscwib «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#===========================================
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["Angel1 buka qr","Angel1 open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done W⃟   I⃟   B⃟   ")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Angel2 buka qr","Angel2 open qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done W⃟   I⃟   B⃟   ")
                    else:
            ...
            elif msg.text in ["Angel3 open qr","Angel3 buka qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done W⃟   I⃟   B⃟   ")
                    else:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["Angel1 close qr","Angel1 tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Angel2 tutup qr","Angel2 close qr"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done W⃟   I⃟   B⃟   ")
                    else:
            ...
            elif msg.text in ["Angel3 tutup qr","Angel3 close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
		...
		for ticket_id in n_links:
            ...
            elif "Angel1" == msg.text:
              if msg.from_ in admin:
                cl.sendText(msg.to,Smid)
            elif "Angel2" == msg.text:
              if msg.from_ in admin:
                ki.sendText(msg.to,mid)
            elif "Angel3" == msg.text:
              if msg.from_ in admin:
                kk.sendText(msg.to,Amid)
            elif "Angel4" == msg.text:
              if msg.from_ in admin:
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print "[Command] Check"
                                chiya += rom[1] + "\n"
                        cl.sendText(msg.to, " By : W⃟   I⃟   B⃟    \nRead : %s\n\n✖ Sider :\n%s\nPoint creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
                        except:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.updateGroup(G)
                print "Semua Sudah Lengkap W⃟   I⃟   B⃟   "
                
            elif msg.text in ["Angel1 join"]:
    ...
    #-------------Fungsi Tag All Start---------------#
                 ...
                 if jml > 400 and jml < 500:
                    ...
                    mention2(msg.to, nm5)
                 if jml > 500:
                    cl.sendText(msg.to,'Member melebihi batas W⃟   I⃟   B⃟   ')
                 cnt = Message()
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in owner:
                print "[Command]Like executed"
                cl.sendText(msg.to,"Kami Siap Like Status Teman Boss W⃟   I⃟   B⃟   ")
                cl.sendText(msg.to,"Kami Siap Like Status W⃟   I⃟   B⃟   \nKami Delay untuk beberapa Detik\nJangan perintah kami dulu sampai kami Selesai Ngelike")
                try:
                  autolike()
                except:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Angel 1 Hadir......")
                cl.sendText(msg.to,"Angel 2 Hadir......")
                cl.sendText(msg.to,"Angel 3 Hadir......")
                cl.sendText(msg.to,"Angel 4 Hadir.......")
                cl.sendText(msg.to,"Angel 5 Hadir..... ")
                cl.sendText(msg.to,"Semua Hadir booos  W⃟   I⃟   B⃟    ")
...
#---------------------Sc invite owner ke group------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
            elif msg.text in ["Wib"]:
              msg.contentType = 13
              msg.contentMetadata = {'mid':  'u4a361586c55ac4ef218a0a9b78b2f1b3'}
              cl.sendText(msg.to,"======ENG ING EEEENG=========")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======TARAAAAAAAAAAA=========")
              cl.sendText(msg.to,"Itu Creator Kami Yang Manis dan yg paling eheeem 😄😄😄")
      #-------------Fungsi Chat ----------------
