...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="+c6My92znQ5+akW.d0KpPnsTwZgiamlTiMj7cOVUcck1A9uvnnIKYzc0Cxg=")
cl.loginResult()

ki = kk = kc = ks = cl

print "Sukses W⃟   I⃟   B⃟    Sayang"
reload(sys)
...
Idline: http://line.me/ti/p/~oscwib""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ B⃟   y⃟    :⃟    W⃟   I⃟   B⃟    »»» http://line.me/ti/p/~oscwib «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#===========================================
    ...
    #-----------------=Selesai=------------------
            ...
            elif msg.text in ["Angel1 buka qr","Luffy open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Angel2 buka qr","Zorro open qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Angel3 open qr","Sanji buka qr"]:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["Angel1 close qr","Luffy tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Angel2 tutup qr","Zorro close qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Angel3 tutup qr","Sanji close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print "[Command] Check"
                                chiya += rom[1] + "\n"
                        cl.sendText(msg.to, " B⃟   y⃟    :⃟    W⃟   I⃟   B⃟    \nRead : %s\n\n✖ Sider :\n%s\nPoint creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
                        except:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Semua Hadir booos  ༺ WIB ༻ ")
